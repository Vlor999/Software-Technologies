...
\begin{table}[]
    ...
    \begin{tabular}{|c|c|c|}
         ...
         Energy Psys [Joules] & 155,5 & 118,7 \\ \hline
    \end{tabular}
...
The results showed into the results files : \texttt{heavyConsumption.md} compare to the file : \texttt{lightConsumption.md} shows clearly that adding some floating points calculations, not reusing previous results and increasing the number of threads does increase the consumption of energy. As a sum up we do have :
